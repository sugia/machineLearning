...
articles to rank articles by relative importance according to this 
eigenvector centrality.

The traiditional way to compute the principal eigenvector is to use 
the power iteration method.

http://en.wikipedia.org/wiki/Power_iteration 

Here the computation is achieved thanks to Martinsson's Randomized 
SVD algorithm implemented in the scikit.
...
# Where to download the data, if ot already on disk 
...
'''
print the names of the wikipedia related strongest compenents of the 
