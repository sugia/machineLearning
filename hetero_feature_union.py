...
1. Your dataset consists of heterogeneous data types (e.g. raster 
    images and text captions)
2. Your dataset is stored in a Pandas DataFrame and different columns 
    requre different processing pipelines.
...
body in separate pipelines as well as ad hoc features on the body.
We combine them (with weights) using a FeatureUnion and finally train 
a classifier on the combined set of features.
...
class ItemSelector(BaseEstimator, TransformerMixin):
    ...
    The data is expected to be stored in a 2D data structure, 
    where the first index is over features and the second is over samples.
    i.e.
    ...
    (e.g. a list of dicts). If your data is structured this way, 
